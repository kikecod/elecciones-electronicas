...
public class EstudianteDTO implements Serializable{
    ...
    @Size(min = 3, max = 50, message = "El CI debe tener entre 3 y 20 caracteres")
    private String ci;
    ...
    @Size(min = 7, max = 40, message = "El teléfono debe tener entre 7 y 20 caracteres")
    ...
    @Size(min = 3, max = 50, message = "La matrícula debe tener entre 3 y 20 caracteres")
